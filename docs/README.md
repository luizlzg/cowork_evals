...
| [`eval_design.md`](eval_design.md)     | Which cases a skill needs, which assertion answers what, what the fixture has to be, how the route a run took is judged, and the conversation that decides |
