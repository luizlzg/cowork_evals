...
| [`eval_design.md`](eval_design.md)     | Which cases a skill needs, which assertion answers what, what the fixture has to be, and how the route a run took is judged |
